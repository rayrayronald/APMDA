...
//
// class flutter_react_ble extends StatefulWidget {
//   final User user;
//   // final FlutterBlue flutterBlue = FlutterBlue.instance;
//   // final List<BluetoothDevice> devicesList = new List<BluetoothDevice>();
//
//   flutter_react_ble({@required this.user});
//
//   @override
//   State createState() {
//     return _flutter_react_ble(user);
//   }
// }
//
// class _flutter_react_ble extends State<flutter_react_ble> {
//   final User user;
...
//       print('${device.name} found! id: ${device.id} rssi: ${device.rssi} service: ${device.serviceData}');
